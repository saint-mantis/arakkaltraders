    ...
    var qodefGoogleMap = {
                        ...
                        $geocoder.geocode({
                            ...
                            if (status === google.maps.GeocoderStatus.OK && typeof results === 'object') {
                                ...
                                if (typeof cityName === 'string') {
                                    ...
                                    qodef.body.trigger('greenpath_core_trigger_after_autocomplete_places', [placesInput]);
                                }
                            }
                        });
                    } else {
        ...
        addMultipleMarkers: function() {
            ...
            for (var i = 0; i < addressesLatLng.length; i++) {
                ...
                $.each(addressesLatLng[i], function(key, value) {
        ...
        createAutocompletePlaces: function(placeInputID) {
            if (typeof google === 'object' && typeof google.maps.places === 'object') {
                ...
                autocomplete.addListener('place_changed', function() {
                    ...
                    qodef.body.trigger('greenpath_core_trigger_after_autocomplete_places', [placeInputID]);
                });
            }
        },
    };
