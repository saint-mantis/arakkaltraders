(() => {
            ...
            271: e => {
                ...
                e.exports = {
                    ...
                    loadScript: function(e, t = (() => {})) {
                        ...
                        r.type = "text/javascript", r.onerror = function() {
    ...
    s.m = r, s.d = (e, t) => {
    ...
    }, s.f = {}, s.e = e => Promise.all(Object.keys(s.f).reduce(((t, r) => (s.f[r](e, t), t)), [])), s.u = e => "sentry-browser.min.js", s.hmd = e => ((e = Object.create(e)).children || (e.children = []), Object.defineProperty(e, "exports", {
        enumerable: !0,
        set: () => {
            throw new Error("ES Modules may not assign module.exports or exports.*, Use ESM export syntax, instead: " + e.id)
        }
    }), e), s.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), e = {}, t = "asset_composer:", s.l = (r, n, o, i) => {
        if (e[r]) e[r].push(n);
        else {
            var a, c;
            if (void 0 !== o)
            ...
            var l = (t, n) => {
                    ...
                    var s = e[r];
                    if (delete e[r], a.parentNode && a.parentNode.removeChild(a), s && s.forEach((e => e(n))), t) return t(n)
                },
        ...
        class e {
            constructor(e = "", t = {}, r = !1) {
                this.message = e, this.props = t, this.error = Error(this.message), this.isUserError = r, this.fingerprint = this.message
            }
        }
        const t = {},
            r = {},
        ...
        class o {
            constructor(e, t) {
                this.name = e.name, this.id = e.id, this.features = e.features, this.bootstrap = e.bootstrap, this.win = t, this.doc = t.document
            }
            ready() {
                return new Promise(((e, t) => {
                    this.createIframeElement().then((r => {
                        ...
                        })), r.src = "about:blank", this.doc.body.appendChild(r)
                    }))
                }))
            }
            injectMetadata(e, t) {
                ...
                }, Object && Object.freeze && this.deepFreeze(e.zendesk), e.zEQueue = t)
            }
            deepFreeze(e) {
                return Object.freeze(e), void 0 === e || Object.getOwnPropertyNames(e).forEach((t => {
                    null === e[t] || "object" != typeof e[t] && "function" != typeof e[t] || Object.isFrozen(e[t]) || this.deepFreeze(e[t])
                })), e
            }
            injectAssets(e, t) {
                if (!e) return;
            ...
            parentDocumentReady() {
                return new Promise(((t, r) => {
                    "loading" !== this.doc.readyState && this.doc.body ? t() : this.doc.addEventListener("DOMContentLoaded", (() => {
                        const {
                            body: n
                        } = this.doc;
            ...
            createIframeElement() {
                return this.parentDocumentReady().then((() => {
                    ...
                    return e.dataset.product = this.name, e.title = "No content", e.role = "presentation", e.tabIndex = -1, e.allow = "microphone *", e.setAttribute("aria-hidden", !0), e.style.cssText = "width: 0; height: 0; border: 0; position: absolute; top: -9999px", e
                }))
            }
        ...
        class i {
            ...
            load(e, t) {
                return this.productIframe.ready().then((r => {
        ...
        class c {
            ...
            getProductAssets() {
                return {
                    zopimSrc: `https://v2.zopim.com/w?${this.zopimKey}`
                }
            }
            load(e) {
                return new Promise(((t, r) => {
        ...
        class u {
            constructor(e, t) {
                this.version = this.getVersion(e), this.baseUrl = `https://ekr.zdassets.com/compose/${t}`, this.snippetKey = t
            }
            resolveComposeUrl(e = !1) {
                let t = this.baseUrl;
                return this.version && (t += `?${this.getSerializedVersionQueryParam()}`, this.displayWarning()), decodeURI(t)
            }
            displayWarning() {
            ...
            getVersion(e) {
                ...
                if (r) {
                    const e = r.split("/");
                    if (this.validVersion(e[1])) return {
                        name: e[0],
                        string: e[1]
                    }
                }
        ...
        class p {
            ...
            getProducts(e, n = !1) {
                return new Promise(((s, o) => {
                    ...
                    if (n) i.zEACLoaded = !0, i.$zopim ? s(r.products) : s(t.products);
                        ...
                        const t = t => {
                                200 === t.status ? t.json().then((({
                                    products: e
                                }) => {
                                    i.zEACLoaded = !0, s(e)
                                })).catch((() => o(this.error(e)))) : o(this.error(e))
                            },
                            r = new u(i, e).resolveComposeUrl();
                        fetch(r).then(t).catch((() => o(this.error(e))))
                    }
                }))
            }
            loadProducts(e, t = !1) {
            ...
            error(t) {
                return new e("compose request failed", {
                    key: t
                })
            }
        }
        ...
        class h extends l {
            getKey() {
                return new Promise(((t, r) => {
                    ...
                    return n ? this._isHostMapped(n) ? fetch(`https://${n}/embeddable/zendesk_host`).then((n => {
                        200 === n.status ? n.json().then((e => {
                            t(`web_widget/${e.zendesk_host}`)
                        })).catch((t => r(new e(t.message)))) : r(new e("zendesk_host request failed"))
                    })).catch((t => r(new e(t.message)))) : t(`web_widget/${n}`) : r(Error("Zendesk host is not defined"))
                }))
            }
            getZEQueue() {
        ...
        class g extends l {
            getKey() {
                return new Promise(((e, t) => e(`zopim_chat/${(0,a.getQueryParamsString)(g.getScriptSrc(this.win))}`)))
            }
        ...
        const w = {
            ...
            y = () => new Promise((e => {
                f ? e(f) : s.e(996).then(s.bind(s, 858)).then((t => {
                    const {
                        BrowserClient: r,
                        ...
                        integrations: [new i.InboundFilters, new i.FunctionToString, new i.HttpContext],
                        transport: n,
                        stackParser: s
                    });
                    f = new o(a), e(f)
        ...
        function b(t) {
            return t && t instanceof e ? y().then((e => {
                e.withScope((r => {
                    t.fingerprint && r.setFingerprint(t.fingerprint), r.setLevel("warning"), e.captureException(t.error)
            ...
            try {
                ...
                const e = function(e) {
                        return m.isSnippetPresent(e) ? new m(e) : e.document.zendeskHost && e.document.zEQueue ? new h(e) : g.isSnippetPresent(e) ? new g(e) : new m(e)
                    }(window),
                    t = new p(e),
                    r = !1;
                e.getKey().then((e => t.getProducts(e, r))).then((e => {
