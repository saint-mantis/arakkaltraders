/*1710671421,,JIT Construction: v1012111715,en_US*/
...
try {
            ...
            with(this) {
                ...
                __d("CORSRequest", ["Log", "QueryString", "RequestConstants", "sdk.Cookie", "sdk.safelyParseResponse", "wrapFunction"], (function(a, b, c, d, e, f, g) {
                    function h(a, b, d) {
                        ...
                        e instanceof XMLHttpRequest && (e.onreadystatechange = function() {
                ...
                __d("sdk.Auth-public", ["FB", "sdk.Auth", "sdk.Auth.LoginStatus", "sdk.AuthUtils", "sdk.Event", "sdk.Runtime", "sdk.ui", "sdk.warnInsecure"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a() {
                        ...
                        (b = c("sdk.Auth")).subscribe("logout", ES((a = d("sdk.Event")).fire, "bind", !0, a, "auth.logout"));
                        b.subscribe("login", ES(a.fire, "bind", !0, a, "auth.login"));
                        b.subscribe("authresponse.change", ES(a.fire, "bind", !0, a, "auth.authResponseChange"));
                        b.subscribe("status.change", ES(a.fire, "bind", !0, a, "auth.statusChange"));
                        b.subscribe("loginDenied", ES(a.fire, "bind", !0, a, "auth.denied"));
                        b.subscribe("loginError", ES(a.fire, "bind", !0, a, "auth.error"));
                        c("sdk.Runtime").subscribe("AccessToken.change", function(a) {
                    ...
                    var h = c("Type").extend({
                        constructor: function(a, b, e, f) {
                            ...
                            this.subscribe("xd.resize", function(b) {
                                ...
                                (a = d("sdk.PluginUtils")).resize(g._iframeOptions.root, a.parse(b.width), a.parse(b.height));
                            ...
                            var j = d("UrlMap").resolve("www") + "/plugins/" + e + ".php?",
                                k = {};
                            ...
                            this._iframeOptions = {
                                ...
                                name: l,
                                width: this._config.mobile_fullsize && c("sdk.UA").mobile() ? void 0 : k.width || 1e3,
                                height: k.height || 1e3,
                                style: {
                                    border: "none",
                                    visibility: "hidden"
                            ...
                            this.isFluid() && k.width !== "auto" && (d("sdk.DOM").addCss(this._element, "fb_iframe_widget_fluid_desktop"), !k.width && this._config.full_width && (this._element.style.width = "100%", this._iframeOptions.root.style.width = "100%", this._iframeOptions.style.width = "100%", this._params.container_width = this._element.offsetWidth, this._iframeOptions.url = j + c("QueryString").encode(this._params)))
                        },
                ...
                __d("sdk.XFBML.ChatDOM", ["$InternalEnum", "CORSRequest", "ChatPluginEntryPointIconEnum", "ChatPluginEntryPointLabelEnum", "ChatPluginEntryPointSizeEnum", "ChatPluginSDKPreLoggingUtils", "ChatPluginStyleUtils", "DOMPlugin", "Log", "UrlMap", "getJSEnumSafe", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.IdleCallback", "sdk.XFBML.CustomerChatNew", "sdk.fbt", "sdk.feature", "uuidv4"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    var h, i = b("$InternalEnum").Mirrored(["WAITING", "LOADING", "LOADED"]);
                    a = function(a) {
                        babelHelpers.inheritsLoose(b, a);

                        function b(b, e, f, g) {
                            var j;
                            j = a.call(this, b, e, f, g, {
                                allow_guests: "bool",
                                attribution: "string",
                            ...
                            d("ChatPluginSDKPreLoggingUtils").preLogging(Boolean(g.should_use_new_domain), "chat_plugin_sdk_facade_create", j.params, !1);
                            d("sdk.DOM").remove(b);
                            ...
                            j.$ChatDOMFacade$p_5 = new(c("sdk.IdleCallback"))(c("sdk.feature")("chat_plugin_facade_timeout_ms", 8e3), function() {
                                var a = (h || (h = c("performanceAbsoluteNow")))();
                                d("Log").info("facadeperf: Idle callback starts full load in %sms.", a - j.$ChatDOMFacade$p_4);
                        ...
                        e.render = function(a) {
                            ...
                            a = this.$ChatDOMFacade$p_15 ? d("UrlMap").resolve("social_plugin") + "/customer_chat/facade/" : d("UrlMap").resolve("www") + "/plugins/customer_chat/facade/";
                            c("CORSRequest").execute(a, "get", this.params, function(a) {
                                var e, f = (h || (h = c("performanceAbsoluteNow")))();
                                d("Log").info("facadeperf: CORS request completed in %sms.", f - b.$ChatDOMFacade$p_4);
                                if (a.error) return;
                                b.$ChatDOMFacade$p_11 = a.alignment;
                                b.$ChatDOMFacade$p_12 = a.bottom_spacing;
                                b.$ChatDOMFacade$p_13 = a.side_spacing;
                                f = a.theme_color;
                                b.$ChatDOMFacade$p_8 = (e = c("getJSEnumSafe")(c("ChatPluginEntryPointSizeEnum"), (e = a.entry_point_size) == null ? void 0 : e.toUpperCase())) != null ? e : "standard";
                                b.$ChatDOMFacade$p_9 = (e = c("ChatPluginEntryPointLabelEnum").cast(a.entry_point_label)) != null ? e : "none";
                                b.$ChatDOMFacade$p_10 = (e = c("ChatPluginEntryPointIconEnum").cast(a.entry_point_icon_enum)) != null ? e : "none";
                                b.$ChatDOMFacade$p_14 = a.away_hours_enabled && !a.is_page_away;
                                if (b.$ChatDOMFacade$p_9 === "none") {
                                    e = document.createElement("div");
                                    d("sdk.DOM").dangerouslySetInnerHtml(e, a.entry_point_icon_svg);
                                    e = e == null ? void 0 : e.outerHTML;
                                    d("sdk.DOM").dangerouslySetInnerHtml(b.$ChatDOMFacade$p_3, e)
                                } else {
                                    e = a.entry_point_icon_svg;
                                    d("sdk.DOM").dangerouslySetInnerHtml(b.$ChatDOMFacade$p_3, b.$ChatDOMFacade$p_17(e))
                                }
                                e = d("ChatPluginStyleUtils").getEntryPointStyle(a.alignment, a.bottom_spacing, a.side_spacing, !1, !0, a.entry_point_label, b.$ChatDOMFacade$p_8);
                                ES("Object", "assign", !1, b.$ChatDOMFacade$p_3.style, e);
                                b.$ChatDOMFacade$p_3.style.backgroundColor = f;
                                if (b.$ChatDOMFacade$p_14) {
                                    e = d("ChatPluginStyleUtils").getAvailabilityStatusStyleText(a.alignment, a.bottom_spacing, a.side_spacing, a.entry_point_label, a.entry_point_icon_enum, b.$ChatDOMFacade$p_8, !1, !0);
                                    f = document.createElement("div");
                                    ES("Object", "assign", !1, f.style, e);
                                    b.$ChatDOMFacade$p_3.append(f)
                                }
                                d("ChatPluginSDKPreLoggingUtils").preLogging(b.$ChatDOMFacade$p_15, "chat_plugin_sdk_facade_load", b.params)
                            });
                            this.$ChatDOMFacade$p_3.addEventListener("click", function(a) {
                        ...
                        e.$ChatDOMFacade$p_20 = function() {
                            if (this.$ChatDOMFacade$p_2 || this.$ChatDOMFacade$p_1 === i.LOADED) return;
                            if (this.$ChatDOMFacade$p_9 === "none") {
                                var a = this.$ChatDOMFacade$p_8 === "compact" ? 24 : 36;
                                a = this.$ChatDOMFacade$p_21(a);
                                d("sdk.DOM").dangerouslySetInnerHtml(this.$ChatDOMFacade$p_3, '\n          <div class="centered-container">\n            ' + a + "\n          </div>\n        ")
                            } else {
                                a = this.$ChatDOMFacade$p_8 === "compact" ? 20 : 24;
                                a = this.$ChatDOMFacade$p_21(a);
                                if (this.$ChatDOMFacade$p_10 === "none") {
                                    var b = this.$ChatDOMFacade$p_8 === "compact" ? d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_COMPACT_ICON_MARGIN_RIGHT : d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_STANDARD_ICON_MARGIN_RIGHT;
                                    d("sdk.DOM").dangerouslySetInnerHtml(this.$ChatDOMFacade$p_3.children[0], this.$ChatDOMFacade$p_22(b, a) + this.$ChatDOMFacade$p_3.children[0].innerHTML);
                                    if (this.$ChatDOMFacade$p_14) {
                                        b = d("ChatPluginStyleUtils").getAvailabilityStatusStyleText(this.$ChatDOMFacade$p_11, this.$ChatDOMFacade$p_12, this.$ChatDOMFacade$p_13, this.$ChatDOMFacade$p_9, "chat_round_icon", this.$ChatDOMFacade$p_8, !1, !1);
                                        var c = document.createElement("div");
                                        ES("Object", "assign", !1, c.style, b);
                                        d("sdk.DOM").remove(this.$ChatDOMFacade$p_3.children[1]);
                                        this.$ChatDOMFacade$p_3.append(c)
                                    }
                                } else d("sdk.DOM").dangerouslySetInnerHtml(this.$ChatDOMFacade$p_3.children[0].children[0], a)
                            }
                            this.$ChatDOMFacade$p_2 = !0
                        };
                        e.$ChatDOMFacade$p_17 = function(a) {
                            var b = this.$ChatDOMFacade$p_8 === "compact" ? d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_COMPACT_HEIGHT : d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_STANDARD_HEIGHT,
                                c = this.$ChatDOMFacade$p_8 === "compact" ? d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_COMPACT_FONT_SIZE : d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_STANDARD_FONT_SIZE,
                                e = this.$ChatDOMFacade$p_8 === "compact" ? d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_COMPACT_LINE_HEIGHT : d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_STANDARD_LINE_HEIGHT,
                                f = this.$ChatDOMFacade$p_8 === "compact" ? d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_COMPACT_ICON_MARGIN_RIGHT : d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_STANDARD_ICON_MARGIN_RIGHT,
                                g = this.$ChatDOMFacade$p_8 === "compact" ? d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_COMPACT_PADDING_HORIZONTAL : d("ChatPluginStyleUtils").LABELED_ENTRY_POINT_STANDARD_PADDING_HORIZONTAL;
                            return '\n      <div class="label-container" style="\n        height: ' + b + "px;\n        padding: 0 " + g + 'px\n      ">\n        ' + (a && '\n            <div class="label-container-icon" style="\n              margin-right: ' + f + 'px;\n            ">\n              ' + a + "\n            </div>\n          ") + '\n        <div\n          class="label-container-label"\n          style="\n            font-size: ' + c + "px;\n            line-height: " + e + 'px;\n        ">' + this.$ChatDOMFacade$p_18(this.$ChatDOMFacade$p_9).toString() + "</div>\n      </div>\n    "
                        };
                        ...
                        e.$ChatDOMFacade$p_23 = function(a) {
                            if (a && this.$ChatDOMFacade$p_7 && !this.$ChatDOMFacade$p_6) {
                ...
                __d("IframePluginClass", ["Log", "QueryString", "UrlMap", "guid", "sdk.Auth.LoginStatus", "sdk.AuthUtils", "sdk.DOM", "sdk.Event", "sdk.Observable", "sdk.PlatformVersioning", "sdk.PluginUtils", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.XD", "sdk.createIframe"], (function(a, b, c, d, e, f, g) {
                    a = function(a) {
                        ...
                        function b(b, e, f, g, h) {
                            ...
                            i.subscribe("xd.resize.flow", function(a) {
                                ES("Object", "assign", !1, i.iframeOptions.root.style, {
                                    verticalAlign: "bottom",
                                    overflow: ""
                                }), d("sdk.PluginUtils").resize(i.iframeOptions.root, d("sdk.PluginUtils").parse(a.width), d("sdk.PluginUtils").parse(a.height)), i.updateLift(), window.clearTimeout(i.$IframePluginClass$p_1)
                            });
                            i.subscribe("xd.resize", function(a) {
                                ...
                                (b = d("sdk.PluginUtils")).resize(i.iframeOptions.root, b.parse(a.width), b.parse(a.height));
                            ...
                            i.subscribe("xd.resize.iframe", function(a) {
                                d("sdk.PluginUtils").resize(i.iframe, d("sdk.PluginUtils").parse(a.width), d("sdk.PluginUtils").parse(a.height)), i.$IframePluginClass$p_2 = !0, i.updateLift(), window.clearTimeout(i.$IframePluginClass$p_1)
                            });
                        ...
                        e.process = function() {
                            ...
                            this.subscribe("render", function() {
                                d("sdk.Event").fire("iframeplugin:onload"), a.iframe.style.visibility = "visible", a.$IframePluginClass$p_2 || d("sdk.PluginUtils").collapseIframe(a.iframe)
                            });
                ...
                __d("sdk.XFBML.CustomerChatNew", ["ChatPluginSDKPreLoggingUtils", "DOMEventListener", "IframePluginClass", "Log", "MPNExplicitUserInteractions", "MPNLocalState", "QueryString", "UrlMap", "getFacebookOriginForTarget", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.DialogUtils", "sdk.Event", "sdk.UA", "sdk.WebStorage", "sdk.XD", "sdk.XFBML.CustomerChatWrapper", "sdk.cp.Actions", "sdk.cp.Animation", "sdk.cp.Constants", "sdk.cp.Storage", "sdk.createIframe"], (function(a, b, c, d, e, f, g) {
                    ...
                    a = function(a) {
                        ...
                        function b(b, c, e, f) {
                            ...
                            g.show = function(a) {
                                a === void 0 && (a = !0), g.$CustomerChat$p_15 = !1, g.$CustomerChat$p_1 != null && d("sdk.DOM").setStyle(g.$CustomerChat$p_1, "display", "inline"), a && g.$CustomerChat$p_30(g.$CustomerChat$p_4), d("sdk.Event").fire("customerchat.show"), g.$CustomerChat$p_34("show")
                            };
                            g.hide = function() {
                                g.$CustomerChat$p_15 = !0, g.$CustomerChat$p_1 != null && d("sdk.DOM").setStyle(g.$CustomerChat$p_1, "display", "none"), g.$CustomerChat$p_29(g.$CustomerChat$p_4), d("sdk.Event").fire("customerchat.hide"), g.$CustomerChat$p_34("hide")
                            };
                            g.showDialog = function() {
                                g.$CustomerChat$p_1 != null && d("sdk.DOM").setStyle(g.$CustomerChat$p_1, "display", "inline"), g.$CustomerChat$p_30(g.$CustomerChat$p_4), g.$CustomerChat$p_34("showDialog")
                            };
                            g.hideDialog = function() {
                                g.$CustomerChat$p_29(g.$CustomerChat$p_4), g.$CustomerChat$p_34("hideDialog")
                            };
                            g.update = function(a) {
                                var b;
                                d("sdk.XD").sendToFacebook((b = g.$CustomerChat$p_5) != null ? b : "", {
                            ...
                            g.$CustomerChat$p_18();
                            d("ChatPluginSDKPreLoggingUtils").preLogging(g.$CustomerChat$p_16, "chat_plugin_sdk_dialog_iframe_create", g.params, !1);
                            return g
                        }
                        var e = b.prototype;
                        e.$CustomerChat$p_17 = function() {
                            ...
                            a = this.$CustomerChat$p_16 ? d("UrlMap").resolve("social_plugin") + "/" + this.tag + ".php?" : d("UrlMap").resolve("www") + "/plugins/" + this.tag + ".php?";
                        ...
                        e.$CustomerChat$p_18 = function() {
                            var a = this,
                                b;
                            this.subscribe("render", function() {
                                d("ChatPluginSDKPreLoggingUtils").preLogging(a.$CustomerChat$p_16, "chat_plugin_sdk_dialog_iframe_load", a.params)
                            });
                            ...
                            this.subscribe("xd.mpn.updateGreetingAppearance", function(b) {
                                c("sdk.cp.Actions").setDialogAppearance(a.$CustomerChat$p_10, b)
                            });
                            ...
                            this.subscribe("xd.mpn.updateIconAppearance", function(b) {
                                c("sdk.cp.Actions").setDialogAppearance(a.$CustomerChat$p_3, b)
                            });
                            ...
                            (b = d("sdk.XFBML.CustomerChatWrapper")).CustomerChatInternalEvent.subscribe(b.CustomerChatInternalEventType.SHOW, this.show);
                            b.CustomerChatInternalEvent.subscribe(b.CustomerChatInternalEventType.HIDE, this.hide);
                            b.CustomerChatInternalEvent.subscribe(b.CustomerChatInternalEventType.SHOW_DIALOG, this.showDialog);
                            b.CustomerChatInternalEvent.subscribe(b.CustomerChatInternalEventType.HIDE_DIALOG, this.hideDialog);
                            b.CustomerChatInternalEvent.subscribe(b.CustomerChatInternalEventType.UPDATE, this.update)
                        };
                        e.$CustomerChat$p_21 = function(a) {
                            var b = this;
                            this.$CustomerChat$p_1 && d("sdk.DOM").remove(this.$CustomerChat$p_1);
                            var e = a.frameName,
                                f = a.iconSVG,
                            ...
                            this.$CustomerChat$p_3 = c("sdk.createIframe")({
                                url: this.$CustomerChat$p_16 ? c("sdk.cp.Constants").blankFrameNewDomainURL : c("sdk.cp.Constants").blankFrameURL,
                                name: j,
                                root: g.contentRoot,
                                tabindex: -1,
                                width: 60,
                                ...
                                onload: function() {
                                    d("ChatPluginSDKPreLoggingUtils").preLogging(b.$CustomerChat$p_16, "chat_plugin_sdk_icon_iframe_load", b.params), b.$CustomerChat$p_2 = j, b.$CustomerChat$p_26(), b.$CustomerChat$p_27(), window.setTimeout(function() {
                                        d("sdk.DOM").remove(i)
                                    }, 100)
                                }
                            });
                            this.$CustomerChat$p_1 && this.$CustomerChat$p_1.setAttribute(c("sdk.cp.Constants").attribute.alignment, a.alignment);
                            this.$CustomerChat$p_1 && d("sdk.Content").append(this.$CustomerChat$p_1);
                            ...
                            this.$CustomerChat$p_8 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    b.$CustomerChat$p_9 = k, b.$CustomerChat$p_26(), b.$CustomerChat$p_27()
                                }
                            });
                            d("sdk.Content").append(this.$CustomerChat$p_8, g.contentRoot);
                            var l = "unread_" + e;
                            this.$CustomerChat$p_6 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    b.$CustomerChat$p_7 = l, b.$CustomerChat$p_26(), b.$CustomerChat$p_27()
                                }
                            });
                            d("sdk.Content").append(this.$CustomerChat$p_6, g.contentRoot);
                            f = c("sdk.UA").mobile();
                            if (!f) {
                                var m = "greeting_" + e;
                                this.$CustomerChat$p_10 = c("sdk.createIframe")({
                                    ...
                                    onload: function() {
                                        b.$CustomerChat$p_11 = m, b.$CustomerChat$p_26(), b.$CustomerChat$p_27()
                                    }
                                });
                                d("sdk.Content").append(this.$CustomerChat$p_10, g.contentRoot)
                            }
                        };
                        e.$CustomerChat$p_27 = function() {
                            this.$CustomerChat$p_2 !== null && this.$CustomerChat$p_7 !== null && this.$CustomerChat$p_9 !== null && this.$CustomerChat$p_5 !== null && this.$CustomerChat$p_11 !== null && !this.$CustomerChat$p_12 && (this.$CustomerChat$p_12 = !0, this.inform("iframes_loaded"))
                        };
                        e.$CustomerChat$p_26 = function() {
                            ...
                            this.$CustomerChat$p_19({
                                ...
                                iconSrc: (a = this.$CustomerChat$p_3) == null ? void 0 : a.src,
                                unreadSrc: (a = this.$CustomerChat$p_6) == null ? void 0 : a.src,
                        ...
                        e.$CustomerChat$p_22 = function(a) {
                            ...
                            this.$CustomerChat$p_1 && (e && this.$CustomerChat$p_1.setAttribute(c("sdk.cp.Constants").attribute.mobilePath, e), a && this.$CustomerChat$p_1.setAttribute(c("sdk.cp.Constants").attribute.desktopBottomSpacing, a.toString()));
                            ...
                            if (a && !this.$CustomerChat$p_14) {
                                if (e == c("sdk.cp.Constants").path.landingPage) {
                                    f = d("sdk.cp.Animation").iframeBounceInAnimation(this.$CustomerChat$p_1);
                                    f != null && d("sdk.DOM").addCss(this.$CustomerChat$p_4, f)
                                }
                                e != c("sdk.cp.Constants").path.landingPage && e != c("sdk.cp.Constants").path.bubble && this.$CustomerChat$p_28()
                            }
                            this.$CustomerChat$p_15 && this.hide()
                        };
                        e.$CustomerChat$p_23 = function(a) {
                            a = a.shouldHide;
                            a === "true" ? this.$CustomerChat$p_29(this.iframe) : this.$CustomerChat$p_30(this.iframe)
                        };
                        e.$CustomerChat$p_24 = function(a) {
                            a = a.shouldHide;
                            a === "true" ? this.$CustomerChat$p_31(this.$CustomerChat$p_10) : this.$CustomerChat$p_32(this.$CustomerChat$p_10)
                        };
                        e.getParams = function() {
                            return {
                                allow_guests: "bool",
                        ...
                        e.$CustomerChat$p_33 = function(a, b) {
                            ...
                            this.$CustomerChat$p_13 === null ? c("getFacebookOriginForTarget")(function(a) {
                                d.$CustomerChat$p_13 = a, f(d.$CustomerChat$p_13)
                            }, e) : f(this.$CustomerChat$p_13)
                        };
                        e.$CustomerChat$p_20 = function(a) {
                            var b;
                            this.$CustomerChat$p_33((b = this.$CustomerChat$p_2) != null ? b : "", a)
                        };
                        e.$CustomerChat$p_19 = function(a) {
                            var b;
                            this.$CustomerChat$p_33((b = this.$CustomerChat$p_5) != null ? b : "", a)
                        };
                        ...
                        e.$CustomerChat$p_30 = function(a) {
                            ...
                            if (this.$CustomerChat$p_14) {
                                ...
                                var b = d("sdk.cp.Animation").iframeBounceInAnimation(this.$CustomerChat$p_1),
                                    e = d("sdk.cp.Animation").iframeBounceOutAnimation(this.$CustomerChat$p_1);
                                ...
                                if (c("sdk.UA").mobile()) d("sdk.DOM").setStyle(a, "maxHeight", "100%"), d("sdk.DOM").setStyle(a, "height", "100%"), d("sdk.DOM").setStyle(a, "width", "100%");
                                    ...
                                    e = this.$CustomerChat$p_1 && d("sdk.DOM").getAttr(this.$CustomerChat$p_1, c("sdk.cp.Constants").attribute.desktopBottomSpacing);
                        ...
                        e.$CustomerChat$p_29 = function(a) {
                            ...
                            if (!this.$CustomerChat$p_14) {
                                ...
                                var e = d("sdk.cp.Animation").iframeBounceInAnimation(this.$CustomerChat$p_1),
                                    f = d("sdk.cp.Animation").iframeBounceOutAnimation(this.$CustomerChat$p_1);
                                e != null && d("sdk.DOM").removeCss(a, e);
                                f != null && d("sdk.DOM").addCss(a, f);
                                var g = {};
                                c("sdk.cp.Constants").animationEvents.forEach(function(e) {
                                    var f = function(e) {
                                        b.$CustomerChat$p_14 && (d("sdk.DOM").setStyle(a, "maxHeight", "0"), d("sdk.DOM").setStyle(a, "minHeight", "0"), c("sdk.cp.Constants").animationEvents.forEach(function(b) {
                ...
                __d("sdk.XFBML.CustomerChatWrapper", ["$InternalEnum", "sdk.Observable", "sdk.XFBML.ChatDOM"], (function(a, b, c, d, e, f, g) {
                    ...
                    var h = function(b) {
                        ...
                        d.process = function() {
                            ...
                            this.$CustomerChatWrapper$p_1 = new(c("sdk.XFBML.ChatDOM"))(this.$CustomerChatWrapper$p_2, this.$CustomerChatWrapper$p_3, this.$CustomerChatWrapper$p_4, this.$CustomerChatWrapper$p_5);
                ...
                __d("sdk.SharedStringConstants", ["sdk.fbt"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    b = {
                        continueWith: (a = c("sdk.fbt"))._("Continue with {facebook_app_name} or {instagram_app_name}"),
                        continueWithShort: a._("{facebook_app_name} or {instagram_app_name}"),
                        loginButtonAriaLabel: a._("Continue with Facebook or Instagram"),
                        logout: a._("Logout"),
                        logoutButtonAriaLabel: a._("Logout the current website"),
                        titleText: a._("Choose Account"),
                        promptText: a._("Which account would you like to use to log in?"),
                        facebookText: a._("Log in with Facebook"),
                        facebookTextShort: a._("Log in"),
                        instagramText: a._("Log in with Instagram"),
                        disambiguationDialogAriaLabelText: a._("Log in with Facebook or Instagram"),
                        fbButtonText: a._("Continue with Facebook"),
                        igButtonText: a._("Continue with Instagram")
                    };
                ...
                __d("sdk.XFBML.MessengerCheckboxWrapper", ["sdk.Observable", "sdk.XFBML.MessengerCheckbox"], (function(a, b, c, d, e, f, g) {
                    ...
                    var h = function(b) {
                        ...
                        d.process = function() {
                            ...
                            this.$MessengerCheckboxWrapper$p_1 = new(c("sdk.XFBML.MessengerCheckbox"))(this.$MessengerCheckboxWrapper$p_2, this.$MessengerCheckboxWrapper$p_3, this.$MessengerCheckboxWrapper$p_4, this.$MessengerCheckboxWrapper$p_5);
                            this.$MessengerCheckboxWrapper$p_1.subscribe("render", function() {
                                a.inform("render")
                            });
                ...
                __d("sdk.XFBML.MessengerMessageUsWrapper", ["sdk.Observable", "sdk.XFBML.MessengerMessageUs"], (function(a, b, c, d, e, f, g) {
                    ...
                    var h = function(b) {
                        ...
                        d.process = function() {
                            ...
                            this.$MessengerMessageUsWrapper$p_1 = new(c("sdk.XFBML.MessengerMessageUs"))(this.$MessengerMessageUsWrapper$p_2, this.$MessengerMessageUsWrapper$p_3, this.$MessengerMessageUsWrapper$p_4, this.$MessengerMessageUsWrapper$p_5);
                            this.$MessengerMessageUsWrapper$p_1.subscribe("render", function() {
                                a.inform("render")
                            });
                ...
                __d("sdk.XFBML.SendToMessengerWrapper", ["sdk.Observable", "sdk.XFBML.SendToMessenger"], (function(a, b, c, d, e, f, g) {
                    ...
                    var h = function(b) {
                        ...
                        d.process = function() {
                            ...
                            this.$SendToMessengerWrapper$p_1 = new(c("sdk.XFBML.SendToMessenger"))(this.$SendToMessengerWrapper$p_2, this.$SendToMessengerWrapper$p_3, this.$SendToMessengerWrapper$p_4, this.$SendToMessengerWrapper$p_5);
                            this.$SendToMessengerWrapper$p_1.subscribe("render", function() {
                                a.inform("render")
                            });
                ...
                __d("sdk.api-public", ["ApiClient", "FB", "sdk.Runtime", "sdk.Scribe", "sdk.api", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a() {
                        ...
                        (a = c("ApiClient")).setDefaultParams({
                            sdk: "joey"
                        });
                ...
                __d("sdk.time-public", ["runOnce", "sdk.Event", "sdk.Time"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a() {
                        ...
                        a.subscribe("iframeplugin:create", c("runOnce")(function() {
                            return d("sdk.Time").log("pluginframe")
                        }));
                        a.subscribe("iframeplugin:onload", c("runOnce")(function() {
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1012111715","namespace":"FB","message":"' + e.message + '"}}');
